      ...
      {recipeData.meals.map((item) => {
        return (
          <div key={item.idMeal} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col sm:flex sm:flex-row items-center gap-10 px-10">
              <img
                src={item.strMealThumb}
                alt=""
                className="h-[400px] w-[300px] sm:h-[500px] sm:w-[400px] rounded-3xl"
              />
           ...
           text-green-500"
            ...
            <div className="px-14">
              ...
              <p className="px-10 mt-8 whitespace-pre-line">
